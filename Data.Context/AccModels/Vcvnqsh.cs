...
namespace narit_mis_api.AccModels
{
    public partial class Vcvnqsh
    {
        ...
        public string Fccontacth { get; set; } = null!;
        public string Fctotelno { get; set; } = null!;
        public string Fctofaxno { get; set; } = null!;
        public string Fctoemail { get; set; } = null!;
        public string Fcpdf01 { get; set; } = null!;
        public string Fcpdf02 { get; set; } = null!;
        public string Fcpdf03 { get; set; } = null!;
        public string Fcpdf04 { get; set; } = null!;
        public string Fcpdf05 { get; set; } = null!;
