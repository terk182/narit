...
{
    public partial class Glhead
    {
        public string Fcudate { get; set; } = null!;
        public string Fcdataser { get; set; } = null!;
        public string Fcskid { get; set; } = null!;
        public string Fclupdapp { get; set; } = null!;
        public string Fcglheadre { get; set; } = null!;
        public string Fccorp { get; set; } = null!;
        public string Fcbranch { get; set; } = null!;
        public string Fcclosed { get; set; } = null!;
        public string Fcstep { get; set; } = null!;
        public string Fcstyle { get; set; } = null!;
        public string Fclink { get; set; } = null!;
        public DateTime Fddate { get; set; }
        public string Fcaccbook { get; set; } = null!;
        public string Fccode { get; set; } = null!;
        public string? Fmremark { get; set; }
        public string? Fmremark2 { get; set; }
        public string Fccreateby { get; set; } = null!;
        public string Fcpostby { get; set; } = null!;
        public string Fccorrectb { get; set; } = null!;
        public string Fcpostcorr { get; set; } = null!;
        public string Fcfrompgl { get; set; } = null!;
        public string Fccanlink { get; set; } = null!;
        public string Fccpatadj { get; set; } = null!;
        public string Fccreatety { get; set; } = null!;
        public string Fceafterr { get; set; } = null!;
        public string Fcatstep { get; set; } = null!;
        public string Fcapprover { get; set; } = null!;
        public string Fcseltag { get; set; } = null!;
        public DateTime Ftdatetime { get; set; }
        public int Fimillisec { get; set; }
        public DateTime? Fdentrydat { get; set; }
        public string Fcentrytim { get; set; } = null!;
        public string Fcutime { get; set; } = null!;
        public decimal Fnlocked { get; set; }
        public string Fcfix { get; set; } = null!;
        public string Fcmandate { get; set; } = null!;
        public DateTime? Fdaudit { get; set; }
        public decimal Fnisaudit { get; set; }
        public DateTime? Ftlastupd { get; set; }
        public DateTime? Fdmandate { get; set; }
        public string Fccmd1 { get; set; } = null!;
        ...
        public string Fclockby { get; set; } = null!;
        public DateTime? Ftlock { get; set; }
        ...
        public string Fcisbudget { get; set; } = null!;
