...
namespace narit_mis_api.AccModels
{
    public partial class Vedipric
    {
        ...
        public string FcedinoHb { get; set; } = null!;
        public string FcedinoSp { get; set; } = null!;
        public string Fcpayedino { get; set; } = null!;
        public string Fcaprf { get; set; } = null!;
