...
namespace narit_mis_api.AccModels
{
    public partial class Vtkmpd
    {
        ...
        public string Fcpdstype { get; set; } = null!;
        public string Fcispass { get; set; } = null!;
        public DateTime? Fddate { get; set; }
        public string Fcseq { get; set; } = null!;
        public string Fcproblem { get; set; } = null!;
        public string Fcsolution { get; set; } = null!;
        public string Fcchkempl { get; set; } = null!;
        public DateTime? Fdcheck { get; set; }
