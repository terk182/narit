...
namespace narit_mis_api.AccModels
{
    public partial class Person02
    {
        ...
        public string Fctask { get; set; } = null!;
        public string Fcispov { get; set; } = null!;
        ...
        public string Fccontpost { get; set; } = null!;
        public string Fccontsect { get; set; } = null!;
        public DateTime? Fdstcont { get; set; }
        public string Fcempl { get; set; } = null!;
        public string Fcstatus { get; set; } = null!;
        public string Fcisdecide { get; set; } = null!;
