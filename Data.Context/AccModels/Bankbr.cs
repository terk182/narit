...
{
    public partial class Bankbr
    {
        public string Fcdataser { get; set; } = null!;
        public string Fcskid { get; set; } = null!;
        public string Fcbank { get; set; } = null!;
        ...
        public string Fcbotcode { get; set; } = null!;
        public string Fccntryiso { get; set; } = null!;
        public string Fcpostiso { get; set; } = null!;
        public string Fcbriso { get; set; } = null!;
        public string Fcaddress1 { get; set; } = null!;
        public string Fcaddress2 { get; set; } = null!;
