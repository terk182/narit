...
namespace narit_mis_api.AccModels
{
    public partial class Sdrefh
    {
        ...
        public string Fcqcplant { get; set; } = null!;
        public string Fcsdtype { get; set; } = null!;
        public string Fcsdqcmbk { get; set; } = null!;
        public string Fcsdcode { get; set; } = null!;
        public string Fcsdrefno { get; set; } = null!;
        public DateTime? Fdsddate { get; set; }
