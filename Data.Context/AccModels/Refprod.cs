...
namespace narit_mis_api.AccModels
{
    public partial class Refprod
    {
        ...
        public string Fcrefpdtyp { get; set; } = null!;
        ...
        public string Fcshowcomp { get; set; } = null!;
        public string Fcrootseq { get; set; } = null!;
        public string Fcpformula { get; set; } = null!;
        ...
        public decimal Fndiscpcn { get; set; }
        public string Fcdiscstr { get; set; } = null!;
        public decimal Fnqtyatdat { get; set; }
        ...
        public decimal Fncostamt { get; set; }
        public decimal Fnpriceke { get; set; }
        public decimal Fndiscamtk { get; set; }
        public decimal Fnxrate { get; set; }
        public decimal Fncostadj { get; set; }
        public string? Fmremark2 { get; set; }
        public string? Fmremark3 { get; set; }
        public string? Fmremark4 { get; set; }
        public string? Fmremark5 { get; set; }
        public string? Fmremark6 { get; set; }
        public string? Fmremark7 { get; set; }
        public string? Fmremark8 { get; set; }
        public string? Fmremark9 { get; set; }
        public string? Fmremark10 { get; set; }
        public string? Fmmemdata { get; set; }
        public string Fctranwhy { get; set; } = null!;
        public string Fctimestam { get; set; } = null!;
        public string Fcqcpass { get; set; } = null!;
        public string Fcgvpolicy { get; set; } = null!;
        public string Fcmfgrunb { get; set; } = null!;
        public string Fcmfgrune { get; set; } = null!;
        public string Fcsubbr { get; set; } = null!;
        public string Fcplant { get; set; } = null!;
        public DateTime? Ftlastupd { get; set; }
        public string Fclaystep { get; set; } = null!;
        public string Fcprochain { get; set; } = null!;
        public string Fcxferstep { get; set; } = null!;
        public DateTime? Ftxfer { get; set; }
        public string Fcrefdo { get; set; } = null!;
        public DateTime? Fdexpire { get; set; }
        public string Fcstore { get; set; } = null!;
        public string Fcgag { get; set; } = null!;
        public string? Fmtextke { get; set; }
        public DateTime? Fdmfgdate { get; set; }
        public string Fctxno { get; set; } = null!;
        public string Fcrecostty { get; set; } = null!;
        public decimal Fndefapric { get; set; }
        public string Fcgl { get; set; } = null!;
        public decimal Fnrefqty { get; set; }
        ...
        public decimal Fncostavg { get; set; }
        public decimal Fncostfifo { get; set; }
        public decimal Fncostlot { get; set; }
        public string Fclocation { get; set; } = null!;
        public string Fcpriceby { get; set; } = null!;
        public string Fccreateby { get; set; } = null!;
        public string Fccorrectb { get; set; } = null!;
        public decimal Fnprodage { get; set; }
        public decimal Fncoststd { get; set; }
        ...
        public string Fcremlocat { get; set; } = null!;
    }
}
