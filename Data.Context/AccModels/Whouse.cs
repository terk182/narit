...
namespace narit_mis_api.AccModels
{
    public partial class Whouse
    {
        ...
        public decimal Fnfrgperum { get; set; }
        public string Fcforpo { get; set; } = null!;
        public string Fcforso { get; set; } = null!;
        public string Fcmcanin { get; set; } = null!;
        public string Fcmcanout { get; set; } = null!;
        public string Fcfcanin { get; set; } = null!;
        public string Fcfcanout { get; set; } = null!;
        public string Fcchkfg { get; set; } = null!;
        public string Fcchkrm { get; set; } = null!;
        ...
        public string Fcaddr11 { get; set; } = null!;
        public string Fcaddr12 { get; set; } = null!;
        public string Fcaddr21 { get; set; } = null!;
        public string Fcaddr22 { get; set; } = null!;
        public string Fctel { get; set; } = null!;
        public string Fcfax { get; set; } = null!;
