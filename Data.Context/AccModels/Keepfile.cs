...
namespace narit_mis_api.AccModels
{
    public partial class Keepfile
    {
        ...
        public string Fcfiletype { get; set; } = null!;
        public string Fcfilename { get; set; } = null!;
        public DateTime? Ftdatemodi { get; set; }
        public decimal Fnsize { get; set; }
        public string Fcbackmach { get; set; } = null!;
        public string Fcbackpath { get; set; } = null!;
        public string Fctabmemo { get; set; } = null!;
