...
namespace narit_mis_api.AccModels
{
    public partial class Vpvstran
    {
        ...
        public string Fctrancorp { get; set; } = null!;
        public string Fcdriverid { get; set; } = null!;
        public string Fccarid { get; set; } = null!;
        public decimal Fntrantot { get; set; }
        public decimal Fnpbycust { get; set; }
        public decimal Fnpbysupp { get; set; }
        public decimal Fnpbydest { get; set; }
        public string Fcpermit { get; set; } = null!;
