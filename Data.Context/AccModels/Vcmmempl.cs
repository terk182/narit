...
namespace narit_mis_api.AccModels
{
    public partial class Vcmmempl
    {
        ...
        public string Fcproduct { get; set; } = null!;
        public string Fcperiod { get; set; } = null!;
        public string Fctarget { get; set; } = null!;
        public string Fcsale { get; set; } = null!;
        public string Fcinvoice { get; set; } = null!;
