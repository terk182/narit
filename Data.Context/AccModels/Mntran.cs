...
namespace narit_mis_api.AccModels
{
    public partial class Mntran
    {
        ...
        public string Fcmnbook { get; set; } = null!;
        public DateTime Fddate { get; set; }
        public string Fccqtype { get; set; } = null!;
        public string Fcisbank { get; set; } = null!;
        public string Fcdebttype { get; set; } = null!;
        ...
        public decimal Fntaxbase { get; set; }
        public decimal Fnvatamt { get; set; }
        public decimal Fntaxamt { get; set; }
