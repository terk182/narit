...
namespace narit_mis_api.AccModels
{
    public partial class Orderhx2
    {
        ...
        public string Fcwarrstr { get; set; } = null!;
        public string Fcadvstr { get; set; } = null!;
        public string Fcretenstr { get; set; } = null!;
        public string Fcpenalstr { get; set; } = null!;
