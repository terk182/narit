...
namespace narit_mis_api.AccModels
{
    public partial class Vcumulem
    {
        ...
        public string Fcsinvoice { get; set; } = null!;
        public decimal Fncommamt { get; set; }
        public decimal Fnaccpoint { get; set; }
        public string Fcseq { get; set; } = null!;
        public string Fcempl { get; set; } = null!;
        public decimal Fncomempl { get; set; }
        public decimal Fnpointemp { get; set; }
        public string Fcreceipt { get; set; } = null!;
        public string Fcvcucondi { get; set; } = null!;
        public decimal Fncomdeduc { get; set; }
        public decimal Fnpntdeduc { get; set; }
        public string Fcbinvoice { get; set; } = null!;
        ...
        public decimal Fncomspeci { get; set; }
