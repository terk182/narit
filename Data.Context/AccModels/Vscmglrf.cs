...
namespace narit_mis_api.AccModels
{
    public partial class Vscmglrf
    {
        ...
        public string Fcdelizone { get; set; } = null!;
        public string Fclayhzone { get; set; } = null!;
        public string Fcclltzone { get; set; } = null!;
        public string Fcdelimthd { get; set; } = null!;
        public string Fcdelistat { get; set; } = null!;
        public decimal Fndelipoin { get; set; }
