...
namespace narit_mis_api.AccModels
{
    public partial class Prodx6
    {
        ...
        public string Fcseg01 { get; set; } = null!;
        public string Fcseg02 { get; set; } = null!;
        public string Fcseg03 { get; set; } = null!;
        public string Fcseg04 { get; set; } = null!;
        public string Fcseg05 { get; set; } = null!;
        public string Fcseg06 { get; set; } = null!;
        public string Fcseg07 { get; set; } = null!;
        public string Fcseg08 { get; set; } = null!;
        public string Fcseg09 { get; set; } = null!;
        public string Fcseg10 { get; set; } = null!;
