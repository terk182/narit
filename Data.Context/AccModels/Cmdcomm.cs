...
namespace narit_mis_api.AccModels
{
    public partial class Cmdcomm
    {
        ...
        public string Fcsid { get; set; } = null!;
        public string Fcsource { get; set; } = null!;
        public string Fcregcomp { get; set; } = null!;
        public string Fcstatus { get; set; } = null!;
        public string Fccmdname { get; set; } = null!;
        public string Fcaction { get; set; } = null!;
        public string Fctabname { get; set; } = null!;
        public string Fctabskid { get; set; } = null!;
        public string? Fmemail01 { get; set; }
        public string? Fmemail02 { get; set; }
        public string? Fmattach01 { get; set; }
        public string? Fmattach02 { get; set; }
        public string? Fmmsg01 { get; set; }
        public string? Fmmsg02 { get; set; }
