...
namespace narit_mis_api.AccModels
{
    public partial class Asched
    {
        ...
        public string Fcqcsysobj { get; set; } = null!;
        public string Fcqnsysobj { get; set; } = null!;
        public string Fccmdline { get; set; } = null!;
        public string Fccrprog { get; set; } = null!;
        public DateTime? Fttime { get; set; }
        public string? Fmoption { get; set; }
        public string Fcstat { get; set; } = null!;
        public string Fcoption { get; set; } = null!;
