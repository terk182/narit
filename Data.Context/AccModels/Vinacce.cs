...
namespace narit_mis_api.AccModels
{
    public partial class Vinacce
    {
        ...
        public string Fcvinno { get; set; } = null!;
        public string Fcreftype { get; set; } = null!;
        public string Fcreftab { get; set; } = null!;
        public string Fcrefskid { get; set; } = null!;
        public string Fccaracces { get; set; } = null!;
        public string Fcaccestyp { get; set; } = null!;
        public string Fcischeck { get; set; } = null!;
        public DateTime? Fdrecacces { get; set; }
        public decimal Fnqty { get; set; }
        public string Fcum { get; set; } = null!;
        public decimal Fnumqty { get; set; }
        public string Fcrefmast { get; set; } = null!;
        ...
        public string Fcisfix { get; set; } = null!;
        public DateTime? Fdinstall { get; set; }
        public string Fcinstsect { get; set; } = null!;
