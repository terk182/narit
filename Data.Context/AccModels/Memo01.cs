...
namespace narit_mis_api.AccModels
{
    public partial class Memo01
    {
        ...
        public string Fckeepfile { get; set; } = null!;
        ...
        public string? Fmmemdatab { get; set; }
        public string? Fmmemdatac { get; set; }
        public string? Fmmemdatad { get; set; }
        public string? Fmmemdatae { get; set; }
        public string? Fmmemdataf { get; set; }
