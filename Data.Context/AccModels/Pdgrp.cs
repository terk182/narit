...
namespace narit_mis_api.AccModels
{
    public partial class Pdgrp
    {
        ...
        public string Fcaccbcash { get; set; } = null!;
        public string Fcaccbcred { get; set; } = null!;
        public string Fcaccscash { get; set; } = null!;
        public string Fcaccscred { get; set; } = null!;
        public string Fccreatety { get; set; } = null!;
        public string Fceafterr { get; set; } = null!;
        public string Fcseltag { get; set; } = null!;
        public DateTime Ftdatetime { get; set; }
        public int Fimillisec { get; set; }
        public string Fcaccstock { get; set; } = null!;
        public string Fcfchr { get; set; } = null!;
        public string Fcaccscost { get; set; } = null!;
        public string Fcaccitem { get; set; } = null!;
        public DateTime? Ftlastupd { get; set; }
        public decimal Fndlohport { get; set; }
        public DateTime? Ftlastedit { get; set; }
        public string Fccreateap { get; set; } = null!;
        public string Fcaccwip { get; set; } = null!;
        ...
        public string Fcaccconsp { get; set; } = null!;
        public string Fcfchrs { get; set; } = null!;
        public string Fcsname { get; set; } = null!;
        public string Fcsname2 { get; set; } = null!;
        ...
        public string Fcaccwr1 { get; set; } = null!;
