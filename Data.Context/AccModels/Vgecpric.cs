...
namespace narit_mis_api.AccModels
{
    public partial class Vgecpric
    {
        ...
        public string Fcvgech1 { get; set; } = null!;
        public string Fcvgech2 { get; set; } = null!;
        public string Fctrantype { get; set; } = null!;
        public string Fcprictype { get; set; } = null!;
        public string Fcvgechp { get; set; } = null!;
        public decimal Fnflatrate { get; set; }
        public string Fcflatprod { get; set; } = null!;
        public string Fcflatum { get; set; } = null!;
        public decimal Fnflatumqt { get; set; }
        public DateTime? Fdflatbegd { get; set; }
        public decimal Fnflatend { get; set; }
        public decimal Fnvarirate { get; set; }
        public string Fcvariprod { get; set; } = null!;
        public string Fcvarium { get; set; } = null!;
        public decimal Fnvariumqt { get; set; }
        public DateTime? Fdvaribegd { get; set; }
