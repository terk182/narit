...
namespace narit_mis_api.AccModels
{
    public partial class Glrefdt
    {
        ...
        public string Fcaddby { get; set; } = null!;
        public DateTime? Ftadddate { get; set; }
        public string Fceditby { get; set; } = null!;
        public DateTime? Fteditdate { get; set; }
        public string Fccancby { get; set; } = null!;
        public DateTime? Ftcancdate { get; set; }
        public string Fcprnby { get; set; } = null!;
        public DateTime? Ftprndate { get; set; }
        public decimal Fnprncnt { get; set; }
        ...
        public string Fclockprn { get; set; } = null!;
