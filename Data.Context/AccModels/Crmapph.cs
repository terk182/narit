...
namespace narit_mis_api.AccModels
{
    public partial class Crmapph
    {
        ...
        public string Fccrmlead { get; set; } = null!;
        ...
        public DateTime? Fddateapp { get; set; }
        public string Fctimeapp { get; set; } = null!;
        public DateTime? Fdpostdate { get; set; }
        public string Fcposttime { get; set; } = null!;
        public DateTime? Fdcancel { get; set; }
        public string Fcempl { get; set; } = null!;
        public string Fccrcont { get; set; } = null!;
        public string Fcappsubj { get; set; } = null!;
        ...
        public string Fcrepcode { get; set; } = null!;
        public DateTime? Fdrepdate { get; set; }
        public string? Fmrepdtail { get; set; }
        public string Fcisqoute { get; set; } = null!;
        public decimal Fncostamt { get; set; }
        public string Fccreateby { get; set; } = null!;
        public string Fcapproveb { get; set; } = null!;
        public DateTime? Fdapprove { get; set; }
        public string? Fmrepdtai2 { get; set; }
        public string? Fmrepdtai3 { get; set; }
        public string? Fmrepdtai4 { get; set; }
        public string? Fmrepdtai5 { get; set; }
