...
namespace narit_mis_api.AccModels
{
    public partial class Plant
    {
        ...
        public decimal Fnnshift { get; set; }
        public string Fcissuover { get; set; } = null!;
        public string Fcretover { get; set; } = null!;
        public string Fcrcvover { get; set; } = null!;
        public decimal Fnavailabi { get; set; }
        public decimal Fnperform { get; set; }
        public decimal Fnquality { get; set; }
        public decimal Fnoee { get; set; }
