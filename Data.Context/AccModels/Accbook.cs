...
namespace narit_mis_api.AccModels
{
    public partial class Accbook
    {
        ...
        public string Fcfchr2 { get; set; } = null!;
        public string Fcgmodhead { get; set; } = null!;
        public string Fcisvouche { get; set; } = null!;
        public string Fcbaccbook { get; set; } = null!;
        public string Fclinkstyl { get; set; } = null!;
        public string Fcempl { get; set; } = null!;
        public string Fcformh { get; set; } = null!;
        public string Fccreatety { get; set; } = null!;
        public string Fceafterr { get; set; } = null!;
        public DateTime Ftdatetime { get; set; }
        public int Fimillisec { get; set; }
        public string Fcmacchart { get; set; } = null!;
        public string Fcdacchart { get; set; } = null!;
        public string Fcmdrcr { get; set; } = null!;
        public string Fcuaccbook { get; set; } = null!;
        public DateTime? Fdlocked { get; set; }
        public string Fcformhf { get; set; } = null!;
        public string Fcformhl { get; set; } = null!;
        ...
        public string Fccolsend { get; set; } = null!;
        ...
        public string Fcshowvcno { get; set; } = null!;
        public string Fcdaylock { get; set; } = null!;
