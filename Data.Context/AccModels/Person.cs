...
namespace narit_mis_api.AccModels
{
    public partial class Person
    {
        ...
        public string Fcprename { get; set; } = null!;
        public string Fcprename2 { get; set; } = null!;
        public string Fcfname { get; set; } = null!;
        public string Fcfname2 { get; set; } = null!;
        public string Fclname { get; set; } = null!;
        public string Fclname2 { get; set; } = null!;
        public DateTime? Fdbirthdat { get; set; }
        public string Fcsex { get; set; } = null!;
        public string Fcfchrf { get; set; } = null!;
        public string Fcfchrl { get; set; } = null!;
