...
namespace narit_mis_api.AccModels
{
    public partial class Vatsuepy
    {
        ...
        public string Fcepaytype { get; set; } = null!;
        public string Fctobankac { get; set; } = null!;
        public string Fctobank { get; set; } = null!;
        public string Fctobbranc { get; set; } = null!;
        public string Fcservtype { get; set; } = null!;
        public string? Fmremark { get; set; }
        public string Fcnoticeby { get; set; } = null!;
        public string Fccustref1 { get; set; } = null!;
        public string Fccustref2 { get; set; } = null!;
        public string Fccomischg { get; set; } = null!;
        ...
        public string Fcwhtdlvr { get; set; } = null!;
