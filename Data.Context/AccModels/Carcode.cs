...
namespace narit_mis_api.AccModels
{
    public partial class Carcode
    {
        ...
        public DateTime? Fddateca { get; set; }
        public string Fccode { get; set; } = null!;
        public string Fcvinno { get; set; } = null!;
        public string Fcbookno { get; set; } = null!;
        public string Fcsectsold { get; set; } = null!;
        public string Fcsoldtype { get; set; } = null!;
