...
namespace narit_mis_api.AccModels
{
    public partial class Loca1
    {
        ...
        public string? Fmdesc2 { get; set; }
        public string Fcshelf { get; set; } = null!;
        public string Fcblock { get; set; } = null!;
        public string Fclock { get; set; } = null!;
        public string? Fmmapname { get; set; }
