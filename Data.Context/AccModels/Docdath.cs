...
namespace narit_mis_api.AccModels
{
    public partial class Docdath
    {
        ...
        public string Fcsendno { get; set; } = null!;
        public string Fctaylorno { get; set; } = null!;
        public string Fcdrvtaylo { get; set; } = null!;
        public string Fcstartpla { get; set; } = null!;
