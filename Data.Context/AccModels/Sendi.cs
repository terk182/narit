...
namespace narit_mis_api.AccModels
{
    public partial class Sendi
    {
        ...
        public string Fcsendh { get; set; } = null!;
        ...
        public string Fcreftygl { get; set; } = null!;
        public string Fcglref { get; set; } = null!;
        public string Fcradio { get; set; } = null!;
        public DateTime? Ftdelivery { get; set; }
        public DateTime? Ftbegdeli { get; set; }
        public DateTime? Ftenddeli { get; set; }
        ...
        public string Fcbookgl { get; set; } = null!;
        public DateTime? Ftlastedit { get; set; }
        public string Fccreateap { get; set; } = null!;
        public string? Fcdorderh { get; set; }
