...
namespace narit_mis_api.AccModels
{
    public partial class Vjobalow
    {
        ...
        public string Fcnduerate { get; set; } = null!;
        public string Fcoverrate { get; set; } = null!;
        public string Fcarndue { get; set; } = null!;
        public string Fcarover { get; set; } = null!;
