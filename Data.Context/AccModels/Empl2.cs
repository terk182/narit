...
namespace narit_mis_api.AccModels
{
    public partial class Empl2
    {
        ...
        public string Fcaddr1 { get; set; } = null!;
        public string Fcaddr12 { get; set; } = null!;
        public string Fcaddr13 { get; set; } = null!;
        public string Fcaddr2 { get; set; } = null!;
        public string Fcaddr22 { get; set; } = null!;
        public string Fcaddr23 { get; set; } = null!;
        public string Fczip { get; set; } = null!;
        public string Fctel { get; set; } = null!;
        public string Fcfax { get; set; } = null!;
        public string Fcmobile { get; set; } = null!;
        public string Fcemail { get; set; } = null!;
        ...
        public string Fcpicture { get; set; } = null!;
