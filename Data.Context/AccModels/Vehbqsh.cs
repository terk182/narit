...
namespace narit_mis_api.AccModels
{
    public partial class Vehbqsh
    {
        ...
        public string Fcdeciprsn { get; set; } = null!;
        public string Fcbudyear { get; set; } = null!;
        public string Fcsize { get; set; } = null!;
        public string Fcpossible { get; set; } = null!;
        public string Fccommit { get; set; } = null!;
        public decimal Fnvalueke { get; set; }
        public string Fccompet1 { get; set; } = null!;
        public string Fccompet2 { get; set; } = null!;
        public string? Fmpoint { get; set; }
        public string Fcmcompet { get; set; } = null!;
        public decimal Fnfinprike { get; set; }
        public string Fccontrac { get; set; } = null!;
