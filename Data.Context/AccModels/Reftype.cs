...
namespace narit_mis_api.AccModels
{
    ...
    {
        public string Fcdataserf { get; set; } = null!;
        ...
        public string Fcnglname { get; set; } = null!;
        public string Fcrepname { get; set; } = null!;
        public string Fcrepname2 { get; set; } = null!;
        public string Fciscash { get; set; } = null!;
        public string Fcisservic { get; set; } = null!;
        public string Fchasret { get; set; } = null!;
        public string Fcvatdue { get; set; } = null!;
        public string Fcfm4type { get; set; } = null!;
        public string Fccoortype { get; set; } = null!;
        public decimal Fnfactor { get; set; }
        public string Fcforngl { get; set; } = null!;
        public string Fcbaccbook { get; set; } = null!;
        public string Fceditproc { get; set; } = null!;
        public string Fccancproc { get; set; } = null!;
        public string Fcdelproc { get; set; } = null!;
        public string Fcseltag { get; set; } = null!;
        public DateTime Ftdatetime { get; set; }
        public int Fimillisec { get; set; }
        public string Fcfchr { get; set; } = null!;
        public string Fclinkgrp { get; set; } = null!;
        public string Fcsysmod { get; set; } = null!;
        public decimal Fnic { get; set; }
        public decimal Fndebt { get; set; }
        public decimal Fnledger { get; set; }
