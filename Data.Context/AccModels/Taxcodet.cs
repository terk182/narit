...
{
    public partial class Taxcodet
    {
        public string Fcskid { get; set; } = null!;
        public string Fccorp { get; set; } = null!;
        public string Fctaxtype { get; set; } = null!;
        public string Fcrdcode { get; set; } = null!;
        public string Fctaxitem { get; set; } = null!;
        public decimal Fnvalue { get; set; }
        public string Fcvalue { get; set; } = null!;
        public DateTime? Fdvalue { get; set; }
