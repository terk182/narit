...
namespace narit_mis_api.AccModels
{
    public partial class Vctwbuy
    {
        ...
        public string Fcfromsect { get; set; } = null!;
        public DateTime? Fdsenddate { get; set; }
        public string Fctosect { get; set; } = null!;
        public DateTime? Fdrecvdate { get; set; }
        public decimal Fncredday { get; set; }
        public string Fcdomestic { get; set; } = null!;
        public string Fcimport { get; set; } = null!;
        public DateTime? Fdduedate { get; set; }
        public string Fcinsect { get; set; } = null!;
        public string Fcoutsect { get; set; } = null!;
