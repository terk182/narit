...
namespace narit_mis_api.AccModels
{
    public partial class Repset
    {
        ...
        public string? Fmoptdata { get; set; }
        public string? Fmoptdata2 { get; set; }
        public string Fchmsg { get; set; } = null!;
        public decimal Fnisprint { get; set; }
        public decimal Fncolwidth { get; set; }
        public decimal Fncolseq { get; set; }
        public decimal Fncolid { get; set; }
        public decimal Fnitemno { get; set; }
