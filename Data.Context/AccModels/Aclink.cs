...
namespace narit_mis_api.AccModels
{
    public partial class Aclink
    {
        ...
        public string Fcdrcr { get; set; } = null!;
        public string Fcshow { get; set; } = null!;
        public string Fccanuse { get; set; } = null!;
        public string Fcinused { get; set; } = null!;
        public string Fcspec01 { get; set; } = null!;
        public string Fcspec02 { get; set; } = null!;
        public string Fcspec03 { get; set; } = null!;
        public string Fcspec04 { get; set; } = null!;
        public string Fcspec05 { get; set; } = null!;
        public string Fcspec06 { get; set; } = null!;
        public string Fcspec07 { get; set; } = null!;
        public string Fcspec08 { get; set; } = null!;
        public string Fcspec09 { get; set; } = null!;
        public string Fcspec10 { get; set; } = null!;
