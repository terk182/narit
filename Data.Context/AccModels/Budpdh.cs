...
namespace narit_mis_api.AccModels
{
    public partial class Budpdh
    {
        ...
        public decimal Fnpdamt { get; set; }
        public string Fccurrency { get; set; } = null!;
        public decimal Fnxrate { get; set; }
        public decimal Fnpdamtk { get; set; }
        public decimal Fnpdqty { get; set; }
        public string Fcum { get; set; } = null!;
        public decimal Fnumqty { get; set; }
        public decimal Fnactamt { get; set; }
        public DateTime? Fdbudgdate { get; set; }
        public string Fcbudgyear { get; set; } = null!;
