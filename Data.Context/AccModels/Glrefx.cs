...
namespace narit_mis_api.AccModels
{
    public partial class Glrefx
    {
        ...
        public decimal Fnoamt { get; set; }
        public decimal Fnovatamt { get; set; }
        public decimal Fnrevalamt { get; set; }
        public decimal Fnrevalvat { get; set; }
        public decimal Fnxrate { get; set; }
        public decimal Fnoxrate { get; set; }
        ...
        public string Fcglrefxh { get; set; } = null!;
        public string Fcu1acc { get; set; } = null!;
        public string Fcdataimp { get; set; } = null!;
        public string Fcrevaltyp { get; set; } = null!;
