...
namespace narit_mis_api.AccModels
{
    public partial class Srcdoci
    {
        ...
        public string Fcsrcdoch { get; set; } = null!;
        ...
        public string Fcxferr2i { get; set; } = null!;
        public string Fctooluse { get; set; } = null!;
        public string Fcmorderh { get; set; } = null!;
        public decimal Fnmfqty { get; set; }
        public decimal Fnmfumqty { get; set; }
        public string Fcmfum { get; set; } = null!;
        public string Fctran2why { get; set; } = null!;
