...
{
    public partial class Flexdatum
    {
        ...
        public string Fcmasterda { get; set; } = null!;
        public string Fcdatatype { get; set; } = null!;
        public string Fcmaster { get; set; } = null!;
        public string Fcflextype { get; set; } = null!;
        public string Fcflexvalu { get; set; } = null!;
        public decimal Fnflexvalu { get; set; }
        public DateTime? Fdflexvalu { get; set; }
        public DateTime? Ftflexvalu { get; set; }
        public string? Fmflexvalu { get; set; }
