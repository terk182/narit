...
namespace narit_mis_api.AccModels
{
    public partial class Xferrhx1
    {
        ...
        public string Fcapvsect { get; set; } = null!;
        public DateTime? Fdreqdate { get; set; }
        public string Fcisreqpas { get; set; } = null!;
        public string Fcstepx1 { get; set; } = null!;
        public string Fcisdlvy { get; set; } = null!;
        public string Fcisrec { get; set; } = null!;
        public string Fcisexdlvy { get; set; } = null!;
        public DateTime? Fddelivery { get; set; }
        public string Fcredregis { get; set; } = null!;
        public string Fcrecempl { get; set; } = null!;
