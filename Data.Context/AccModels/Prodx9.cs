...
namespace narit_mis_api.AccModels
{
    public partial class Prodx9
    {
        ...
        public string Fctesttype { get; set; } = null!;
        public string Fckeeptype { get; set; } = null!;
        public decimal FnretestM { get; set; }
        public decimal Fnminpobat { get; set; }
