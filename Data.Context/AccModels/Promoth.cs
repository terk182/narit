...
namespace narit_mis_api.AccModels
{
    public partial class Promoth
    {
        ...
        public string Fcmultibil { get; set; } = null!;
        public string Fctrgttype { get; set; } = null!;
        public decimal Fntarget { get; set; }
        public string Fcgetrigty { get; set; } = null!;
        public string Fcgetwhat { get; set; } = null!;
        public decimal Fnrigqty { get; set; }
        public string Fcdiscstr { get; set; } = null!;
        public decimal Fnprice { get; set; }
        public decimal Fnrepeat { get; set; }
