...
namespace narit_mis_api.AccModels
{
    public partial class Morderi
    {
        ...
        public string Fcismainpd { get; set; } = null!;
        ...
        public string Fcprocure { get; set; } = null!;
        ...
        public decimal Fnconsqty { get; set; }
        public decimal Fnconsunit { get; set; }
        public decimal Fnusedqty { get; set; }
        public string Fctools { get; set; } = null!;
        public string Fcstum { get; set; } = null!;
        public decimal Fnstqty { get; set; }
        public decimal Fnstumqty { get; set; }
        public decimal Fnqtybfrel { get; set; }
        public DateTime? Fdfinish { get; set; }
        public decimal Fnissueqty { get; set; }
