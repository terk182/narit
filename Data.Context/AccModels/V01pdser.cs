...
namespace narit_mis_api.AccModels
{
    public partial class V01pdser
    {
        ...
        public string Fcpstep { get; set; } = null!;
        public string Fcsstep { get; set; } = null!;
        public string Fccreatety { get; set; } = null!;
        public string Fceafterr { get; set; } = null!;
        public DateTime Ftdatetime { get; set; }
        public int Fimillisec { get; set; }
        public string Fcseltag { get; set; } = null!;
        public string Fcsticker1 { get; set; } = null!;
        public string Fcsticker2 { get; set; } = null!;
        public string Fccode2 { get; set; } = null!;
        public decimal Fnvatrate1 { get; set; }
        public decimal Fnvatrate2 { get; set; }
        public decimal Fnvatamt { get; set; }
        public decimal Fninsuterm { get; set; }
        public DateTime? Fdinsudate { get; set; }
        public string Fcremark { get; set; } = null!;
        public string Fcwhouse { get; set; } = null!;
        public string Fccylincap { get; set; } = null!;
        public string Fccolor { get; set; } = null!;
