...
namespace narit_mis_api.AccModels
{
    public partial class Packph
    {
        ...
        public string Fcvessel { get; set; } = null!;
        public string Fcvoyage { get; set; } = null!;
        public string Fcportd { get; set; } = null!;
        public DateTime? Fdetddate { get; set; }
        public string Fcshipby { get; set; } = null!;
        public string Fccountrya { get; set; } = null!;
        public string Fccitya { get; set; } = null!;
        public string Fcporta { get; set; } = null!;
        public DateTime? Fdetadate { get; set; }
        public string Fcfrppaid { get; set; } = null!;
        public string Fcsaleterm { get; set; } = null!;
        public string Fcpayterm { get; set; } = null!;
        public decimal Fnfreightk { get; set; }
        public decimal Fninsurek { get; set; }
        public decimal Fnesthandk { get; set; }
        public string? Fmshipmrk1 { get; set; }
        public string? Fmshipmrk2 { get; set; }
        public string? Fmcontact { get; set; }
        public string Fcctinvh { get; set; } = null!;
        public string? Fmpaycond { get; set; }
