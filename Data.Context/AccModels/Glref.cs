...
namespace narit_mis_api.AccModels
{
    public partial class Glref
    {
        ...
        public string Fcfrlocate { get; set; } = null!;
        public string Fctolocate { get; set; } = null!;
        public string Fcfrstore { get; set; } = null!;
        public string Fctostore { get; set; } = null!;
        public string Fcbranchno { get; set; } = null!;
        public string Fcbranchnm { get; set; } = null!;
        ...
        public decimal Fnrevalamt { get; set; }
        public string Fcwhtint { get; set; } = null!;
