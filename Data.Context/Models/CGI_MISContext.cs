...
namespace narit_mis_api.Models
{
    public partial class CGI_MISContext : DbContext
    {
        ...
        public virtual DbSet<RequestFormCommentStatus> RequestFormCommentStatuses { get; set; } = null!;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<RequestBudget>(entity =>
            {
                ...
                entity.Property(e => e.ProcurementByStaff).IsUnicode(false);
            ...
            modelBuilder.Entity<RequestFormApprove>(entity =>
            {
                ...
                entity.HasOne(d => d.RequestForm)
                    ...
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_RequestFormApprove_RequestForm");
            });
            ...
            modelBuilder.Entity<RequestFormCommentStatus>(entity =>
            {
                entity.ToTable("RequestFormCommentStatus");
            ...
            modelBuilder.Entity<RequestFormItem>(entity =>
            {
                ...
                entity.HasOne(d => d.RequestForm)
                    ...
                    .HasForeignKey(d => d.RequestFormId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_RequestFormItem_RequestForm");
            });
