...
{
    public partial class PlanMonthlyOperation
    {
        public PlanMonthlyOperation()
        {
            InverseParentPlanMonthlyOperation = new HashSet<PlanMonthlyOperation>();
            PlanFiles = new HashSet<PlanFile>();
            PlanMonthlyOperationChangeLogs = new HashSet<PlanMonthlyOperationChangeLog>();
        }
        ...
        public virtual ICollection<PlanMonthlyOperation> InverseParentPlanMonthlyOperation { get; set; }
        public virtual ICollection<PlanFile> PlanFiles { get; set; }
        public virtual ICollection<PlanMonthlyOperationChangeLog> PlanMonthlyOperationChangeLogs { get; set; }
    }
}
