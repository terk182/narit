...
namespace narit_mis_api.Models
{
    public partial class PerformanceIndicator
    {
        ...
        {
            InverseParentPerformanceIndicator = new HashSet<PerformanceIndicator>();
            PerformanceIndicatorFiles = new HashSet<PerformanceIndicatorFile>();
        }
        ...
        public virtual PerformanceIndicator? ParentPerformanceIndicator { get; set; }
        public virtual PlanActivity? PlanActivity { get; set; }
        public virtual PlanCore? PlanCore { get; set; }
        public virtual StrategicIndicator? StrategicIndicator { get; set; }
        public virtual ICollection<PerformanceIndicator> InverseParentPerformanceIndicator { get; set; }
        public virtual ICollection<PerformanceIndicatorFile> PerformanceIndicatorFiles { get; set; }
    }
}
